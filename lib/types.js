...
(function() {
  ...
  this.declare('datamill_resume_from_db_settings', function(x) {
    return {
      tests: {
        "x is a datamill_run_phase_settings": function(x) {
          return this.isa.datamill_run_phase_settings(x);
        },
        "x.feed_db is a boolean": function(x) {
          return this.isa.boolean(x.feed_db);
        }
      }
    };
  });
