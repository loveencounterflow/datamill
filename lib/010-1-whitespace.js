(function() {
  'use strict';
  var $, $async, $watch, CND, DATOM, DM, H, SPX, VNR, assign, badge, debug, declare, echo, first, freeze, help, info, isa, jr, last, new_datom, rpr, select, size_of, stamp, thaw, type_of, types, urge, validate, warn, whisper;
