  ...
  where true
    ...
    and doc_line_nr = (
      ...
      * walk_raw_lines(...region_ids) {
        ...
        var doc_file_id, doc_file_nr, doc_loc_id, i, idx, len, line, ref, region_id;
        region_ids = region_ids.flat(2e308);
        for (idx = i = 0, len = region_ids.length; i < len; idx = ++i) {
          region_id = region_ids[idx];
          ({doc_file_id, doc_loc_id} = this._split_region_id(region_id));
          doc_file_nr = idx + 1;
      ...
      _split_region_id(region_id) {
        ...
        match = region_id.match(/^(?<doc_file_id>[^#]+)#(?<doc_loc_id>.+)$/);
        if (match == null) {
          return {
      ...
      * _walk_locs_of_file(file) {
        var doc_file_id, doc_line_nr, doc_loc_id, doc_loc_kind, doc_loc_mark, doc_loc_start, doc_loc_stop, left_slash, length, line, match, ref, ref1, right_slash, stop, text;
        ({doc_file_id} = file);
        //.......................................................................................................
        ...
        for (line of ref) {
          ...
          for (match of ref1) {
            ...
            if ((left_slash === '') && (right_slash === '')) {
              ...
              doc_loc_kind = 'start';
              doc_loc_mark = doc_loc_stop;
              yield ({doc_file_id, doc_line_nr, doc_loc_id, doc_loc_kind, doc_loc_start, doc_loc_stop, doc_loc_mark});
              doc_loc_kind = 'stop';
            } else {
