  ...
  where true
    ...
    and doc_line_nr = (
      ...
      * walk_region_lines(...region_ids) {
        ...
        var doc_loc_id, doc_region_nr, doc_src_id, doc_src_nr, first_line_nr, i, idx, last_line_nr, len, line, ref, region_id, start, stop;
  ...
  where true
    ...
    order by doc_line_nr;`, {doc_region_nr, doc_src_id, first_line_nr, last_line_nr});
      ...
      * _walk_locs_of_source(source) {
        ...
        ref = this.db(this._raw_lines_ps, {doc_src_id});
        //.......................................................................................................
        for (line of ref) {
          ({doc_line_nr} = line);
