(function() {
  ...
  Document = (function() {
    ...
    class Document {
      ...
      _procure_infrastructure() {
        ...
        // TABLES
        //.......................................................................................................
        this.db(SQL`create table ${prefix}file_kinds (
  ...
  primary key ( doc_file_id ) );`);
        ...
        insert_file_kind = this.db.prepare_insert({
          into: `${prefix}file_kinds`
        });
        this.db(() => {
          var clasz, comment, doc_file_kind, doc_file_kind_classname, ref, ref1, results;
          ref = this.file_adapters;
          results = [];
          for (doc_file_kind in ref) {
            clasz = ref[doc_file_kind];
            doc_file_kind_classname = clasz.name;
            comment = (ref1 = clasz.comment) != null ? ref1 : null;
            results.push(this.db(insert_file_kind, {doc_file_kind, doc_file_kind_classname, comment}));
          }
          return results;
        });
        //.......................................................................................................
    ...
    Document.prototype.get_doc_file_kinds = Decorators.get_all_rows('file_kinds');
