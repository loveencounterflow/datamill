(function() {
  'use strict';
  var Decorators, Document, External_text_file, FS, File_adapter_abc, GUY, I, L, PATH, SQL, V, alert, debug, echo, file_adapters, get_base_types, get_document_types, help, info, inspect, isa, log, plain, praise, rpr, sql, type_of, types, urge, warn, whisper;
