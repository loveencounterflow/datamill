...
(function() {
  ...
  this.mark_preamble = function(S) {
    ...
    var d, dbr, dbw, dest, first_lnr, first_vnr_blob, i, key, last_lnr, last_vnr_blob, len, pattern, row, rows, rows_txt, size, start_lnr, start_vnr_blob;
    key = '^line';
    pattern = '<start/>';
    dest = 'preamble';
    dbr = S.mirage.dbr;
  ...
  this.mark_postscript = function(S) {
    ...
    var d, dbr, dbw, first_lnr, first_vnr_blob, i, key, last_lnr, last_vnr_blob, len, pattern, row, rows, rows_txt, size;
    key = '^line';
    pattern = '<stop/>';
    dbr = S.mirage.dbr;
    dbw = S.mirage.dbw;
