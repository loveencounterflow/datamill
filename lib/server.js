(function() {
  'use strict';
  var CKD, Datamill_server, Datamill_server_base, FS, GUY, HDML, HTTP, Koa, NODEXH, NOTIFIER, PATH, Router, SQL, Socket_server, XE, alert, debug, echo, file_server, get_base_types, get_server_types, help, info, inspect, isa, log, mount, plain, praise, rpr, summarize, tabulate, type_of, types, urge, warn, whisper;
  ...
  Datamill_server_base = class Datamill_server_base {
    ...
    _watch_doc_files() {
      ...
      watcher.on('change', async(doc_file_abspath) => {
        ...
        this._notify_change(doc_file_abspath);
