(function() {
  'use strict';
  var CKD, Datamill_server, Datamill_server_base, FS, GUY, HDML, HTTP, Koa, NODEXH, PATH, Router, SQL, Socket_server, Stream, XE, alert, debug, echo, file_server, get_base_types, get_server_types, help, info, inspect, isa, log, mount, plain, praise, rpr, summarize, tabulate, type_of, types, urge, warn, whisper;
