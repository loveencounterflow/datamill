(function() {
  'use strict';
  var $, $drain, $fresh, $show, $watch, CND, DATAMILL, FS, H, PD, VNR, after, badge, debug, declare, echo, first, first_of, help, info, isa, jr, last, last_of, rpr, select, size_of, stamp, type_of, urge, validate, warn, whisper;
  ...
  ({$, $watch, $show, $drain, stamp, select} = PD.export());
...
//# sourceMappingURL=db-benchmark.test.js.map