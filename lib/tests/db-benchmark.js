(function() {
  'use strict';
  var $, $drain, $fresh, $show, $watch, CND, DATAMILL, DATOM, FS, H, SP, VNR, after, badge, debug, declare, echo, first, first_of, help, info, isa, jr, last, last_of, rpr, select, size_of, stamp, type_of, urge, validate, warn, whisper;
...
//# sourceMappingURL=db-benchmark.js.map