...
(function() {
  'use strict';
  var $, $async, $watch, CND, DM, FS, H, OS, PATH, PD, alert, as_padded_lines, assign, badge, cwd_abspath, cwd_relpath, debug, declare, defer, echo, first_of, help, here_abspath, info, inspect, isa, jr, last_of, log, project_abspath, rpr, select, size_of, stamp, test, to_width, type_of, types, urge, validate, warn, whisper, width_of, xrpr;
