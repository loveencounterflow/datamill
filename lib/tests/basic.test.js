(function() {
  'use strict';
  var $, $async, $watch, CND, DM, FS, H, OS, PATH, SP, alert, as_numbered_lines, as_padded_lines, assign, badge, cwd_abspath, cwd_relpath, debug, declare, defer, echo, first_of, help, here_abspath, info, inspect, isa, jr, last_of, log, project_abspath, rpr, select, size_of, stamp, test, to_width, type_of, types, urge, validate, warn, whisper, width_of, xrpr;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._reveal_bug_from_pipestreaming_api_change = async function() {
    var datamill, error, i, len, matcher, probe, probes_and_matchers, quiet, result;
    // [ "A short text", "<p>A short text</p>", null, ]
    // ["```\nCODE\n```","<pre><code>\nCODE\n</code></pre>",null]
    // ["\n# A Headline\n\n> Quote\n> ```\n> CODE\n> ```","\n<h1>A Headline</h1>\n\n<blockquote>\n<p>Quote\n<pre><code>\nCODE\n</code></pre>\n</blockquote>",null]
    // ["First.\n\nSecond.","<p>First.</p>\n\n<p>Second.</p>",null]
    probes_and_matchers = [["# A Headline\n\n> Quote\n", "<h1>A Headline</h1>\n\n<blockquote>\n<p>Quote</p>\n</blockquote>\n", null]];
    //.........................................................................................................
    result = null;
    quiet = true;
    quiet = false;
  ...
  if (module.parent == null) {
    ...
    // test @[ "xxx2" ], { timeout: 1e4, }
    this._reveal_bug_from_pipestreaming_api_change();
  }
