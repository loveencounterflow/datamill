...
(function() {
  'use strict';
  var $, $async, $watch, CND, DM, H, MIRAGE, PD, VNR, assign, badge, cast, cwd_abspath, cwd_relpath, debug, echo, first, first_of, help, here_abspath, info, isa, jr, last, last_of, preamble, project_abspath, rpr, select, size_of, stamp, type_of, urge, validate, warn, whisper, xr;
