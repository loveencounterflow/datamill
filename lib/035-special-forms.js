...
(function() {
  ...
  this._get_symmetric_achr_transform = function(S, start_stop, name) {
    ...
    return $((d, send) => {
      var $vnr;
      if ((select(d, '^achr-split')) && (d.achrs === start_stop)) {
        $vnr = VNR.new_level(d.$vnr, 0);
        //.....................................................................................................
        if (within) {
          $vnr = VNR.advance($vnr);
          send(H.fresh_datom(closing_key, null, {$vnr}));
        } else {
          $vnr = VNR.advance($vnr);
          send(H.fresh_datom(opening_key, null, {$vnr}));
        }
        //.....................................................................................................
        within = !within;
        $vnr = VNR.advance($vnr);
        send(H.fresh_datom('^mktscript', {
          text: d.right,
          $vnr
        }));
      } else {
  ...
  * `code`
  ...
  this.$repeat_phase = function(S) {
    return $watch({last}, (d) => {
      if (d !== last) {
        return null;
      }
      this.pass += +1;
      this.repeat_phase = !(this.pass >= this.pass_max);
      return null;
    });
  };
  ...
  this.$transform = function(S) {
    ...
    pipeline.push(this.$repeat_phase(S));
