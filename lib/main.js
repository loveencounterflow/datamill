(function() {
  'use strict';
  var $, $async, $watch, CND, DATAMILL, DATOM, H, MIRAGE, SP, VNR, assign, badge, cwd_abspath, cwd_relpath, debug, declare, echo, first, first_of, help, here_abspath, info, isa, jr, last, last_of, project_abspath, rpr, select, size_of, stamp, type_of, urge, validate, warn, whisper;
  ...
  this.run_phase = function(S, settings, transform) {
    return new Promise((resolve, reject) => {
      var R, defaults, max_phase_nr, phase_name, phase_nr, pipeline, source;
      defaults = {
  ...
  this.reprise = (S, region) => {
    ...
    S.control.queue.push(SP.new_datom('~reprise', {
      first_vnr,
      last_vnr,
