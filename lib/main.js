...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.render_html = function(S) {
    return new Promise(async(resolve, reject) => {
      return resolve((await this.parse_document(S, ['./900-render-html'])));
    });
  };

  //-----------------------------------------------------------------------------------------------------------
  this.parse_document = function(S, phase_names = null) {
    return new Promise(async(resolve, reject) => {
      var i, len, message, msg_1, msg_2, msg_2a, msg_3, pass, phase, phase_name, ref;
      if (phase_names == null) {
        phase_names = [
          './000-initialize',
          './005-start-stop',
  ...
  this._demo = async function() {
    await (() => {
      return new Promise(async(resolve) => {
        ...
        await this._demo_list_html_rows(datamill);
        //.......................................................................................................
