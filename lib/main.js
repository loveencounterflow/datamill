...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  /* TAINT signature violates principle of putting callables last */
  ...
  this._create_udfs = function(mirage) {
    ...
    db.$.function('datamill_copy_realms_select', {
      deterministic: false,
      varargs: false
    }, function(row) {
      return true;
...
/* name of phase that queued control messages */    return R;
  ...
  this.parse_document = function(S) {
    return new Promise(async(resolve, reject) => {
      var i, len, limit, message, msg_1, msg_2, msg_2a, msg_3, pass, phase, phase_name, phase_names, ref;
      limit = 2e308;
      phase_names = [
        './000-initialize',
        './005-start-stop',
      ...
      while (true) {
        ...
        //.........................................................................................................
          for (i = 0, len = phase_names.length; i < len; i++) {
            ...
            pass = 1;
            msg_1();
            await this.run_phase(S, (ref = phase.settings) != null ? ref : null, phase.$transform(S));
            //...................................................................................................
  ...
  if (module.parent == null) {
    (async() => {
      var $vnr, d, datamill, db, i, idx, last_idx, len, line, lines, lnr, ref, row, settings, text, to_width, width_of;
      //.......................................................................................................
      settings = {
