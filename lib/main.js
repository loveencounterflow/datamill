...
(function() {
  ...
  this.parse_document = function(S, settings) {
    return new Promise(async(resolve, reject) => {
      var defaults, i, len, message, msg_1, msg_2, msg_2a, msg_3, pass, phase, phase_name, ref, ref1;
      defaults = {
        quiet: false,
        phase_names: [
          './000-initialize',
      ...
      while (true) {
        try {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            pass = 1;
            msg_1();
            await this.run_phase(S, (ref1 = phase.settings) != null ? ref1 : null, phase.$transform(S));
            //...................................................................................................
