  ...
  this.new_datamill = function(mirage) {
    ...
    R = {
      ...
      control: {
        active_phase: null,
        queue: [],
        /* A queue for flow control messages */reprise_nr: 0,
        reprise: {
          start_vnr: null,
          stop_vnr: null,
          phase: null
...
/* name of phase that queued control messages */    return R;
  ...
  this.translate_document = function(mirage) {
    return new Promise(async(resolve, reject) => {
      var S, i, len, limit, message, msg_1, msg_2, msg_3, pass, phase, phase_name, phase_names;
      S = this.new_datamill(mirage);
      limit = 2e308;
      phase_names = ['./000-initialize', './005-start-stop', './006-ignore', './010-1-whitespace', './010-2-whitespace-dst', './020-blocks', './025-whitespace-2', './030-1-paragraphs-breaks', './030-2-paragraphs-consolidate', './040-markdown-inline'];
      //.........................................................................................................
      // # './030-escapes'
      // # './035-special-forms'
      // './xxx-validation'
