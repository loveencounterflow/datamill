(function() {
  'use strict';
  var $, $watch, CND, DM, PATH, PD, SP, VNR, XXX_COLORIZER, _color_cache, assign, badge, cast, debug, declare, echo, help, info, isa, jr, rpr, select, size_of, stamp, to_width, type_of, types, urge, validate, warn, whisper, width_of;
