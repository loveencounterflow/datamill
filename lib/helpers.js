(function() {
  'use strict';
  var $, $async, $watch, CND, DM, PATH, PD, VNR, XXX_COLORIZER, _color_cache, assign, badge, cast, debug, declare, echo, equals, help, info, isa, jr, rpr, select, size_of, stamp, to_width, type_of, types, urge, validate, warn, whisper, width_of;
