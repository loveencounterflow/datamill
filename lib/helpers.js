...
//.........................................................................................................
  ...
  this._show_overview = (S, settings, realm) => {
    ...
    var _color, color, combi, dbr, defaults, dent, dest, key, level, line, line_width, omit_count, p, ref, ref1, ref2, ref3, ref4, row, show_blanks, show_stamped, sid, text, value, vnr, xxx_deemphasize_closing_tags, xxxxx;
  ...
  this.show_html = function(datamill) {
    var $vnr, d, db, idx, last_idx, line, lines, lnr, ref1, results, row, text;
    //.......................................................................................................
    ({to_width, width_of} = require('to-width'));
    ...
    for (row of ref1) {
      ...
      results.push((function() {
        ...
        for (idx = i = 0, len = lines.length; i < len; idx = ++i) {
          line = lines[idx];
          if (idx === last_idx) {
            results1.push(echo((CND.reverse(CND.BLUE(to_width(line, 100)))) + (CND.grey(lnr))));
          } else {
            results1.push(echo(CND.reverse(CND.BLUE(to_width(line, 100)))));
          }
        }
        return results1;
      })());
