...
(function() {
  ...
  this.show_overview = (S, settings) => {
    ...
    var _color, color, combi, dbr, defaults, dent, dest, key, level, line, line_width, omit_count, p, ref, ref1, ref2, ref3, ref4, row, text, value, vnr;
    ...
    for (row of ref1) {
      ...
      ref = to_width((ref2 = row.ref) != null ? ref2 : '', 6);
