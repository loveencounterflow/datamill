(function() {
  'use strict';
  var $, $async, $watch, CND, H, PD, VNR, alert, assign, badge, debug, declare, echo, first, help, info, isa, jr, last, last_of, rpr, select, size_of, stamp, type_of, types, urge, validate, warn, whisper, xr;
  ...
  this.$validate_symmetric_keys = function(settings) {
    ...
    return PD.mark_position($((pd, send) => {
      ...
      var d, entry, i, is_first, is_last, is_vnr, key, len, message, name, ref, sigil, was_vnr;
