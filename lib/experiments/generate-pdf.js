(function() {
  'use strict';
  var $, CND, FS, PATH, PD, PUPPETEER, after, alert, assign, async, badge, debug, demo_2, echo_browser_console, get_page, help, info, isa, join_path, jr, page_html_path, rpr, settings, sleep, take_screenshot, urge, warn, whisper;
  ...
  demo_2 = async function() {
    ...
    await page.goto('http://localhost:8080/slugs');
    ...
    urge("^interplot/gpdf@4198-6 waitForSelector");
    ...
    return urge("^interplot/gpdf@4198-9 done");
  };
